        ...
        return (
            <div className='py-20'>
                ...
                <div className='items-center justify-center flex flex-col py-20 space-y-5'>
                    ...
                    <p className='text-bgGreen text-[40px] max-sm:text-[20px] text-center font-medium w-[645px] max-sm:w-[300px]'>We are building an environmentally friendly future</p>
