...
const DistanceSellingContract = () => {
  return (
    <div className="py-10 md:py-20 mt-5 md:mt-10 w-full">
        ...
        <p className='text-bgGreen text-[40px] max-sm:text-[20px] text-center font-medium w-[1145px] max-sm:w-[300px]'>MESAFELİ SATIŞ SÖZLEŞMESİ</p>
        ...
        <div className="flex flex-col space-y-2 md:space-y-5 px-4 md:px-0 max-w-[70rem]">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-[14px] md:text-[16px] text-bgGreen">
                    10.2. Cayma hakkının kullanılması için 14 günlük süre içinde SATICI' ya iadeli taahhütlü posta, faks veya eposta ile yazılı bildirimde bulunulması ve ürünün işbu sözleşmede düzenlenen "Cayma Hakkı Kullanılamayacak Ürünler" hükümleri çerçevesinde kullanılmamış olması şarttır.
                    </p>
                    <p className="text-[14px] md:text-[16px] text-bgGreen">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="flex flex-col space-y-1">
                    <p className="text-[14px] md:text-[16px] text-bgGreen">
                    İşbu sözleşmeden doğan uyuşmazlıklarda şikayet ve itirazlar,  aşağıdaki kanunda belirtilen parasal sınırlar dâhilinde Gaziantep tüketici sorunları hakem heyetine veya tüketici mahkemesine yapılacaktır. Parasal sınıra ilişkin bilgiler aşağıdadır:
                    </p>
                    <p className="text-[14px] md:text-[16px] text-bgGreen">
