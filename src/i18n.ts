    ...
    resources: {
      en: {
        translation: {
          ...
          generalTermsAndCOnd: "General Terms And Condition",
          ...
          "basedOnYourCO2": "Based on your CO2 use calculation",
          "unitPrice2": "Unit Price: 1.20 $/tree",
          "email": "Email",
          "enterEmail": "Enter Email",
          "preferredPlantingLocation": "Preferred Planting Location",
          "select": "Select",
          ...
          "enterTaxAdministrator": "Enter Tax Administrator",
          ...
          "increaseEfficiency": "You increase your environmental efficiency by reducing your carbon emissions.",
          "saveCost": "You save cost with energy efficiency and sustainable applications.",
          "supportBusiness": "You support your business to achieve its sustainability goals.",
          "gainTrust": "You gain the trust and loyalty of your customers and stakeholders.",
          "strengthenReputation": "You strengthen your reputation by complying with environmental regulations.",
          "nefesolSupport": "As Nefesol, we are here to help you maximize your environmental efficiency by guiding your business through the carbon footprint optimization process.",
          ...
          "competitiveAdvantage2": "Competitive Advantage: Green technologies enable businesses to gain competitive advantage. Commitments to sustainability and the use of green technologies are positively perceived by customers and stakeholders. This increases brand reputation and enables you to be the business of choice for customers.",
          "reducingEnvironmentalImpacts": "Reducing Environmental Impacts: Green technologies help businesses reduce their environmental impact by increasing energy efficiency and using environmentally friendly resources. These technologies provide innovation in areas such as utilizing renewable energy sources, waste management, water conservation, and recycling. Thus, it contributes to the protection of natural resources and reduction of carbon emissions.",
          "innovationAndR&D": "Innovation and R&D Opportunities: Green technology incentives provide support to businesses for innovation and R&D studies. These incentives facilitate the allocation of resources to develop innovative solutions and achieve sustainability goals. Businesses can play a leadership role in their sectors by realizing projects related to green technologies. They can be overtaken.",

          "troubleshootingAndDebugging": {
            "title": "Troubleshooting and Debugging: ",
            "content": "When you encounter technical problems, our expert technical support team diagnoses the problems and provides solutions quickly. The team guides you through debugging processes and finds the most suitable solution. strives to provide."
          },
          "updateAndUpgrade": {
            "title": "Update and Upgrade: ",
            "content": "The world of technology is constantly changing and may require updates. Our technical support service helps you keep your business's existing systems and software up to date. It also provides support during upgrade processes and guides you through the implementation of new technologies."
          },
          "remoteAndOnSiteSupport": {
            "title": "Remote and On-Site Support: ",
            "content": "Our technical support services offer remote access tools and on-site intervention options. With remote support, you can quickly solve your technical problems and prevent your business processes from being interrupted. Additionally, with our on-site support service, our expert technical team comes to your business's location and solves problems on-site."
          },
          "consultancyAndTraining": {
            "title": "Consultancy and Training: ",
            "content": "Our technical support service advises you in determining your business' technology-oriented strategies. We also provide training for your staff on technology use and troubleshooting. This allows you to increase the technical capabilities of your business."
          }
      ...
      tr: {
        translation: {
          ...
          smallTrees: "Küçük Ağaç Paketi",
          trees: "Ağaç",
          mediumTrees: "Orta Ağaç Paketi",
          largeTrees: "Büyük Ağaç Paketi",
          breatheNowMax: "HEMEN NEFES OL",
          ...
          millionTrees: "Yıllık 1 Milyon Ağaç",
          perYear: "yılda",
          ...
          contributionCircularEconomy: "Döngüsel Ekonomiye Katkı",
          ...
          distanceSalesContractTitle: "MESAFELI SATIŞ SÖZLEŞMESI",
          parties: "1. TARAFLAR",
          ...
          generalTermsAndCOnd: "Genel Şartlar ve Koşullar",
          ...
          "plantTrees": "Ağaç Dik",
          "returnToCalculator": "Hesap makinesine geri dön",
          "youAreAboutToPlant": "Dikmeye hazırsınız",
          "basedOnYourCO2": "CO2 kullanımınıza dayanarak",
          "unitPrice2": "Birim Fiyat: 1.20 $/ağaç",
          "email": "E-posta",
          "enterEmail": "E-posta Girin",
          "preferredPlantingLocation": "Tercih Edilen Dikim Yeri",
          "select": "Seçin",
          ...
          "town": "Kasaba",
          "enterTown": "Kasaba Girin",
          "street": "Cadde/Sokak",
          "enterStreet": "Cadde/Sokak Girin",
          "postCode": "Posta Kodu",
          "enterPostCode": "Posta Kodu Girin",
          "taxNumber": "Vergi Numarası",
          "enterTaxNumber": "Vergi Numarası Girin",
          "taxAdministrator": "Vergi İdaresi",
          "enterTaxAdministrator": "Vergi İdaresi Girin",
          ...
          "BREATH PACK": "NEFES PAKETİ",
          "generalTerms": {
            "title": "GENEL SATIŞ VE TESLİM ŞARTLARI",
            "paragraph1": "Erma Group Turizm Sanayi ve Ticaret A.Ş. ve www.nefesol.com internet sitesi ve mobil uygulamalar için genel hükümleri; m ve Şartlar",
            "paragraph2": "1. Genel Aşağıda hükümler yalnızca uygulanabilir. Erma Group Turizm Sanayi. Ticaret A.Ş. Antlaşmada, Erma Group A.Ş. olarak anılacaktır. Sözleşme tarafları Müşteri olarak anılacaktır. Diğer koşullar açıkça itiraz etmese ve / veya teslim etmese bile sözleşmenin bir parçası haline gelmez ve / veya gerçekleştirmez.",
            "paragraph3": "2. Sözleşme Bizim teklif ettiğimiz hizmetler hukuki teklifler olarak anlaşılmamalıdır ve bu nedenle değiştirilebilir ve bağlayıcı değildir. Tam tersine, özel bir talebiniz bizim hizmetlerimizden biri için hukuki anlamda teklif olarak kabul edilir. Bir sözleşme yalnızca talebinizi metin formatında (örneğin e-posta) onayladığımızda yapılır. Kayıt formuna iletişim bilgilerinizi girerek ve hesabınızı etkinleştirerek talebinizi sunabilirsiniz. Hizmetlerin kapsamı, sözleşmenin yapıldığı tarihte görülebilen hizmet tanımından kaynaklanmaktadır. Bir sözleşme yapma hakkına sahip değiliz. Bir müşterinin bir sözleşme yapmasını reddetme hakkına sahibiz. Müşteriyle yapılacak herhangi bir sözleşmeye gerekçesiz olarak. Sözleşmenin yapılabilmesi için müşterinin sınırsız hukuki kapasiteye sahip olması ve en az 18 yaşında olması gerekmektedir. Küçüklerle yapılan sözleşmeler dolayısıyla bu tür sözleşmeler dışlanmıştır. saklanmıştır. Ad, adres vb. Sözleşme ilişkisine ilişkin tüm bilgiler, tam ve doğru olarak verilmelidir. Hizmetlerimizi kullanmak için kayıt gerekir. Her müşteri yalnızca bir e-posta adresini kullanabilir. Sözde tek kullanımlık bir e-posta adresi olmamalıdır. Müşteri, Erma Group A.Ş. Hesabını ve diğer bilgilerini, e-posta adresi, kredi kartı numaraları ve son kullanma tarihleri de dahil olmak üzere, işlemleri tamamlamak ve gerekirse müşteri ile iletişim kurabilmek için hemen güncellemeyi kabul eder. Erma Group A.Ş. Erma Group A.Ş. tarafından sağlanan hizmet, yanlış, kusurlu veya eksik müşteri verilerine dayanıyorsa, dolaylı zararlar için sorumlu tutulamaz. Erma Group A.Ş. Sözleşmenin imzalanması için bir evrim mağazası çalıştırır. Erma Group A.Ş. Erma Group A.Ş. www.nefesol.com, www.encheap24.com, www.baumabo.com ve bu sayfaların mobil uygulamalarında müşterilerine hizmet sunmaktadır. Müşteri, sipariş sayfasında belirtilen hizmetler için bağlayıcı bir sipariş vererek [Şimdi] veya [Abone ol] düğmelerini tıklar. Satın alma sözleşmesi, Erma Group A.Ş. Müşterinin siparişini aldıktan hemen sonra e-posta yoluyla sipariş onayını göndererek kabul eder. Sözleşme metni sistemimizde kaydedilir. Genel şartları ve koşulları web sitemizden istediğiniz zaman görebilirsiniz. Bir müşteri hesabınız varsa (profil), Kullanıcı menüsü nden müşteri verilerinize her zaman erişebilirsiniz; Aşağıdaki profilinizi görebilir ve düzenleyebilirsiniz. Siparişinizin verileri ve genel şartlar ve koşulları e-posta yoluyla size gönderilir.",
            "paragraph4": "3. İptal koşulları Bir tüketici iseniz (yani ticari veya mesleki faaliyetinizle ilişkilendirilemeyen bir amaç için sipariş veren bir gerçek kişi), yasal hükümler uyarınca iptal hakkınız bulunmaktadır. www.nefesol.com ve net) sürdürme hareketidir. Bireysel müşteriler için iptal süresi 24 saattir. Kurumsal veya büyük hacimli satın alımlar için iptal süresi 3 gündür. Aksi takdirde, aşağıdaki hükümler iptal hakkı için geçerlidir: BIR SÖZLEŞME iptal hakkının, Erma Group A.Ş. ile müşteri ve müşteri arasındaki iptal bildirimine dayalı olarak iptal hakkının uygulanması konusundaki kararına [Çamtepe mah. Mahmut Tevfik Atay Bulv. Gaziantep Technopark no:4 A Kapı no:1 Şahinbey Gaziantep, info@nefesol.com] net bir açıklama (örneğin, posta veya e-posta yoluyla) ile yazılı bir açıklama (örneğin, posta veya e-posta yoluyla) BIR SÖZLEŞME Kararına göre iptal hakkı kararı alabilirsiniz, ancak zorunlu değildir. BIR SÖZLEŞME örneği. Aşağıdaki modülü iptal için kullanabilirsiniz. Sayfalı ve doldurulmuş iptal formuna web sitemiz (www.nefesol.com) bir müşteri varsa bu siteye erişebilir ve e-posta gönderebilir. Bu seçenekten yararlanan bir müşteri bu seçenekten yararlanan bir müşteri, örnek bir iptal talebi aldığında geri bildirim alacaktır (örneğin, e-posta ile). iptal tarihinin karşılanması için iptal edilen müşterinin iptal hakkı konusunda bildirimde bulunması yeterlidir. İPTALIN SONU Eğer müşteri bu sözleşmeyi feshederse, Erma Group A.Ş. daha önce belirtilen on dört gün içinde bu sözleşmenin bu kararı alındığı gün boyunca. bir müşteriden teslim alınan tüm ödemeleri geri ödemesi gerekmektedir. Bu geri ödeme, Erma Group A.Ş. yani müşteri ile yapılan orijinal işlem için iade edilen bankayı kullanır, net olan şeyler. anlaşıldığı gibi anlaşıldığı gibi anlaşıldığı gibi. Anlamak meselesinde uygulanan yirmi has is. is geri iade düzenlere. ve iade. hesap. It. şirketidir. geri. bank. from. it. [CANCELLATION FORM. Geri. want. den. ev. is. i. sözleşme. yaptır. geri. sırt. is. plan. build. Company. Tree. with. 2. Location of [on] Distant. Make. at. 6. Geri. Ev. at. 1. to. I. I/We. (I) [L. For. at. Hizmet /[ with. bir. Şimdi. bir. hizmet. name. information: firm: Hasta. place. Muamma. name. (town/vill.) name. date. history. signature. At. (Only. if. Ev. att. on. date. (Ters. S. was. eve. I. line. - I/We. will. canceled. BIR. be. necessary. - The end of the demolition.",
            "paragraph5": "4. Price prices can be seen on the payment, billing website or online store and tax-related amounts, amount of dollars, and the request that results from the Erma Group A.Ş. has the right to change the price of any subscription offer, at the time of the customer at any time. Erma Group A.Ş. Treated as a block, 15 (fifteen) that will remain in force. times. With. e-mail to the e-mail address of the symbol. Yes. If the new subscription is cancelled, the contract must be paid for the monthly. The subscription is not. I was. Using. Erma Group A.Ş. The mouth. has the right to establish a membership. The order at the online shop. I'm sure. payment. for information. No. Et. as. invoice. Erma Group A.Ş. In this regard, you are. hand. to the. company. for the. with. box. digital. to issue or provide. in. machine. I. Under. the. invoicing. Time. with. Şey. at the end of the. E. I don't know. S. Büyü. whether. ediy. electronic. form.",
            "paragraph6": "5. İşbu ve son. of. the. event. ve. waste. without a change. contracts. according to. to. will. if. agreement. one. bird. on. use. S. on. use. to. E. Month. your. single. to. If. your. on. before. third day. with. you. until. may be. canceled. Without the room. in the house. to be informed. as a choice.",
            "paragraph7": "6. Warranty &Cedil;in. of. fire, natural. from. etc. weather. I'm going to be. reason. for. in. also. the. Mr. Group. not. to. to. to. is. whether. it's up to. to. to. the. attitude. of the. view. it is. in. goes. see. you. the. in. the. a. high. one. in. Is. I. forest. in. I'm sure. I'm doing. you. first. if. my. in. my. journey. or. in. place. or. I think. to. to visit. my. communication.",
            "paragraph8": "7. S. for. due to. the. A. to the. Erma. Group. Insurance. responsibility. Tüm. about. again. k. by. for. one. bird. will. in. one. or. face. in. for. l. it is. in the. problem. to. do. decision. From. across. as. outside. the scope of the. or. for. time. the. find. can."
          },

          "accuracyReliability": "Doğruluk ve Güvenilirlik:",
          "certificationDescription": "Sertifikasyon, karbon eşitleme faaliyetlerinizin güvenilirliğini doğrulamanın ve kanıtlamanın önemli bir yoludur. Müşterileriniz, karbon emisyonlarınızı etkin bir şekilde yönettiğinizi ve gerçekleştirdiğiniz karbon dengeleme projelerinin doğrulandığını bilmektedir. İşletmenizin çevresel sorumluluklarını yerine getirdiğini ve sürdürülebilir bir geleceğe olan bağlılığınızı gösteren güçlü bir beyandır.",
          "complianceStandards2": "Uluslararası Standartlara Uygunluk:",
          "nefesolCertification2": "Nefesol Sertifikasyon Hizmeti, uluslararası kabul görmüş karbon standartlarına uygun olarak yürütülmektedir. Bu, operasyonlarınızı karbon izleme, raporlama ve doğrulama konularında en iyi uygulamalarla uyumlu hale getirmenize olanak tanır.",
          "imageAdvantage": "İmaj ve Rekabet Avantajı:",
          "competitiveAdvantage": "Sertifikasyon, işletmenizin çevresel sürdürülebilirliğe olan taahhütlerini kanıtlamanın yanı sıra imaj ve rekabet avantajı elde etmenizi sağlar. Karbon ayak izinizi doğrulamak ve sertifikalarla eşitleme çabalarınızı desteklemek, müşterileriniz ve paydaşlarınız tarafından sizi tercih etmelerinde önemli bir faktör olabilir. Ayrıca, pazardaki sürdürülebilirlik liderliğinizi vurgulayarak rekabet avantajı elde edebilirsiniz.",
          "traceabilityTransparency22": "İzlenebilirlik ve Şeffaflık:",
          "traceabilityDescription": "Sertifikasyon, karbon eşitleme faaliyetlerinizin izlenebilir ve şeffaf olmasını sağlar. Projelerinizin ve tazminat çabalarınızın detaylarını, karbon emisyonlarını azaltma ve doğaya katkı sağlama yöntemlerini açıkça belgelemektedir. Bu, paydaşlarınızın, müşterilerinizin ve toplumun güvenini kazanmanıza olanak tanır.",
          carbonAssessment: "Karbon Ayak İzi Değerlendirmesi: İlk adımda, uzman danışmanlarımız müşterilerimizin faaliyetlerine dayalı karbon ayak izini belirlemek için ayrıntılı bir analiz gerçekleştirir. Enerji tüketimi, ulaşım, atık yönetimi ve diğer faktörler göz önünde bulundurularak, karbon emisyonlarının ana kaynakları ve miktarı belirlenir.",
          carbonReduction: "Karbon Azaltım Stratejileri: Karbon ayak izini azaltmak için etkili stratejileri belirlemek önemlidir. Danışmanlarımız, enerji verimliliği, yenilenebilir enerji kullanımı, atık azaltımı ve geri dönüşüm gibi alanlarda müşterilerimize özel çözümler sunmaktadır. Bu stratejiler, çevresel etkiyi azaltmak ve operasyonel verimliliği artırmak için uygulanabilir.",
          carbonCompensation: "Karbon Tazminat Hizmetleri: Karbon emisyonlarını tamamen ortadan kaldırmak her zaman mümkün olmayabilir. İşte bu noktada karbon telafi hizmetlerimiz devreye giriyor. Müşterilerimizin orman dikimi, ağaçlandırma projeleri ve yenilenebilir enerji yatırımları gibi yöntemlerle karbon emisyonlarını dengelemelerine yardımcı oluyoruz. Bu sayede müşterilerimiz, çevre üzerindeki etkilerini azaltırken doğaya geri dönüş yapma fırsatı yakalıyor.",
          monitoringReporting: "İzleme ve Raporlama: Karbon danışmanlık sürecinde, müşterilerimizin ilerlemesini izlemek ve raporlamak önemlidir. Karbon emisyonlarını izlemek, etkili stratejilerin uygulanmasını sağlar ve sürekli iyileştirmeye olanak tanır. Danışmanlarımız düzenli olarak raporlar sunar ve müşterilerimizin performanslarını değerlendirmek için gerekli bilgileri sağlar.",

          "websiteSeoOptimization": "Web Sitesi ve SEO Optimizasyonu:",
          "websiteSeoOptimizationText": "İşletmenizin dijital varlığını güçlendirmek için etkileyici bir web sitesi ve SEO (Arama Motoru Optimizasyonu) stratejisine ihtiyacınız var. Nefesol olarak, işletmenize özel bir web tasarımı sunarken, arama motorlarında daha iyi sıralamalar elde etmek için SEO optimizasyonu yapıyoruz.",
          "socialMediaManagement": "Sosyal Medya Yönetimi:",
          "socialMediaManagementText": "Sosyal medya, markanızı geniş kitlelere duyurma ve etkileşim sağlama gücüne sahip; bir araçtır. Nefesol olarak, sosyal medya platformlarınızı yönetiyor ve içerik oluşturma, yayınlama, topluluk yönetimi ve reklam kampanyalarında sizi destekliyoruz.",
          "contentMarketing": "İçerik Pazarlaması:",
          "contentMarketingText": "Etkili içerik, hedef kitlenizi çekmek ve etkilemek kadar markanızın değerini ve uzmanlığını göstermek için de önemlidir. Nefesol olarak, orijinal ve ilginç içerikler oluşturuyor, blog yazıları, makaleler, infografikler ve videolar gibi çeşitli formatlarda içerik sunuyoruz.",
          "emailMarketing": "E-posta Pazarlaması:",
          "emailMarketingText": "E-posta pazarlaması, potansiyel müşterilere ve mevcut müşterilere doğrudan ulaşmanın etkili bir yoludur. Nefesol olarak, etkileyici e-posta kampanyaları oluşturuyor, kişiselleştirilmiş e-postalar gönderiyor ve müşteri sadakatini artırmak için otomasyon süreçlerini uyguluyoruz.",

          "carbonFootprintAssessment": "Karbon Ayak İzi Değerlendirmesi: İlk adımda, uzman bir ekip olarak işletmenizin faaliyetlerini analiz eder ve karbon ayak izini belirlemek ve işletmenizin mevcut çevresel etkilerini ölçmek için detaylı bir değerlendirme yaparız. Bu, enerji tüketimi, ulaşım, atık yönetimi ve diğer faktörleri içerir.",
          "dataCollectionAnalysis": "Veri Toplama ve Analiz: Karbon ayak izini hesaplamak için gerekli verileri toplar ve analiz ederiz. Bu, işletmenizin enerji tüketimi, ulaşım faaliyetleri, üretim süreçleri ve tedarik zinciri gibi faktörleri içerir. Elde ettiğimiz verileri kullanarak işletmenizin karbon emisyonlarını etkileyen ana kaynakları belirleriz.",
          "optimizationStrategies": "Optimizasyon Stratejileri: Verileri analiz edip mevcut durumu değerlendirdikten sonra, karbon ayak izini azaltmak için özelleştirilmiş optimizasyon stratejileri belirleriz. Bu stratejiler, enerji verimliliğini artırma, yenilenebilir enerji kullanma, atık azaltma ve yeşil tedarik zinciri yönetimi gibi konuları içerir. Ayrıca, iş süreçlerindeki iyileştirmeler ve teknolojik yenilikler de dikkate alınır.",
          "implementationMonitoring": "Uygulama ve İzleme: Optimizasyon stratejilerinin uygulanması sırasında işletmenizle iş birliği içinde çalışırız. Stratejilerin başarılı bir şekilde uygulanması için size rehberlik eder ve süreci takip ederiz. Ayrıca, ilerlemeyi izlemek ve sonuçları değerlendirmek için düzenli raporlar sunarız.",

          "increaseEfficiency": "Karbon emisyonlarınızı azaltarak çevresel verimliliğinizi artırırsınız.",
          "saveCost": "Enerji verimliliği ve sürdürülebilir uygulamalar ile maliyet tasarrufu sağlarsınız.",
          "supportBusiness": "İşletmenizin sürdürülebilirlik hedeflerine ulaşmasını desteklersiniz.",
          "gainTrust": "Müşterilerinizin ve paydaşlarınızın güvenini ve sadakatini kazanırsınız.",
          "strengthenReputation": "Çevresel düzenlemelere uyarak itibarınızı güçlendirirsiniz.",
          "nefesolSupport": "Nefesol olarak, karbon ayak izi optimizasyon sürecinde işletmenize rehberlik ederek çevresel verimliliğinizi en üst düzeye çıkarmanıza yardımcı olmak için buradayız.",

          "financialAdvantages": "Finansal Avantajlar: Yeşil teknoloji teşvikleri işletmelere çeşitli finansal avantajlar sağlar. Bu teşvikler, hibe ve teşvik programları, vergi indirimleri, düşük faizli krediler ve enerji maliyetlerinden tasarruf gibi teşvikleri içerir. Bu teşvikler, yeşil teknolojilerin benimsenmesini teşvik ederken işletmelerin maliyetlerini azaltmalarına yardımcı olur.",
          "competitiveAdvantage2": "Rekabet Avantajı: Yeşil teknolojiler işletmelerin rekabet avantajı elde etmelerini sağlar. Sürdürülebilirliğe bağlılık ve yeşil teknolojilerin kullanımı müşteriler ve paydaşlar tarafından olumlu algılanır. Bu, marka itibarını artırır ve müşteriler için tercih edilen işletme olmanızı sağlar.",
          "reducingEnvironmentalImpacts": "Çevresel Etkileri Azaltma: Yeşil teknolojiler, enerji verimliliğini artırarak ve çevre dostu kaynakları kullanarak işletmelerin çevresel etkilerini azaltmalarına yardımcı olur. Bu teknolojiler, yenilenebilir enerji kaynaklarının kullanımı, atık yönetimi, su tasarrufu ve geri dönüşüm gibi alanlarda yenilik sağlar. Böylece, doğal kaynakların korunmasına ve karbon emisyonlarının azaltılmasına katkıda bulunur.",
          "innovationAndR&D": "İnovasyon ve AR-GE Fırsatları: Yeşil teknoloji teşvikleri, işletmelere inovasyon ve AR-GE çalışmaları için destek sağlar. Bu teşvikler, yenilikçi çözümler geliştirmek ve sürdürülebilirlik hedeflerine ulaşmak için kaynakların tahsisini kolaylaştırır. İşletmeler, yeşil teknolojilerle ilgili projeleri gerçekleştirerek sektörlerinde liderlik rolü oynayabilirler. Geçebilirler.",

          "troubleshootingAndDebugging": {
            "title": "Sorun Giderme ve Hata Ayıklama: ",
            "content": "Teknik sorunlarla karşılaştığınızda, uzman teknik destek ekibimiz sorunları teşhis eder ve hızlı çözümler sunar. Ekip, hata ayıklama süreçlerinde size rehberlik eder ve en uygun çözümü bulur. sağlamaya çalışır."
          },
          "updateAndUpgrade": {
            "title": "Güncelleme ve Yükseltme: ",
            "content": "Teknoloji dünyası sürekli değişiyor ve güncellemeler gerektirebilir. Teknik destek hizmetimiz, işletmenizin mevcut sistemlerini ve yazılımlarını güncel tutmanıza yardımcı olur. Ayrıca, yükseltme süreçlerinde destek sağlar ve yeni teknolojilerin uygulanmasında size rehberlik eder."
          },
          "remoteAndOnSiteSupport": {
            "title": "Uzaktan ve Yerinde Destek: ",
            "content": "Teknik destek hizmetlerimiz, uzaktan erişim araçları ve yerinde müdahale seçenekleri sunar. Uzaktan destek ile teknik sorunlarınızı hızlı bir şekilde çözebilir ve iş süreçlerinizin kesintiye uğramasını önleyebilirsiniz. Ayrıca, yerinde destek hizmetimiz ile uzman teknik ekibimiz işletmenizin konumuna gelerek yerinde sorunları çözer."
          },
          "consultancyAndTraining": {
            "title": "Danışmanlık ve Eğitim: ",
            "content": "Teknik destek hizmetimiz, işletmenizin teknolojiye yönelik stratejilerini belirlemede size danışmanlık yapar. Ayrıca, personelinize teknoloji kullanımı ve sorun giderme konularında eğitimler sunarız. Bu, işletmenizin teknik yeteneklerini artırmanızı sağlar."
          },
